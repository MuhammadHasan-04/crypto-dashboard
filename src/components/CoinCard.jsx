...
export default function CoinCard({ coin }) {
  ...
  return (
    ...
    <button onClick={handleWatchList}  className={`mt-1 py-2 ${containedInWatchList ? "bg-red-500 hover:bg-red-600 text-white text-sm rounded-2xl text-xs" : "bg-green-500 hover:bg-green-600 text-white text-sm"}`}>{containedInWatchList ? "Add to WatchList" : "Remove from WatchList"}</button>
